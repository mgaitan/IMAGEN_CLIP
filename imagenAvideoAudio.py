...
Usage:
  imagenAvideoAudio.py --duracion=<duracion> --nombre_extension=<nombre_extension>
...
def imagen_clip(duracion, nombre_extension):
    ...
    miaudio = AudioFileClip("my_audiofile.mp3")
    miaudio = miaudio.set_duration(t)
    final.set_audio(miaudio).write_videofile(mivideo, fps=15)
